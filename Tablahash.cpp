...
int main() {
    ...
    HashTableDouble hashDouble(tableSize);  // NUEVO
    ...
    cout << "\nDoble hashing:\n";
    cout << "Tiempo de insercion: " << insertDoubleTime.count() << " s\n";
    cout << "Tiempo de busqueda: " << searchDoubleTime.count() << " s\n";
    cout << "Colisiones: " << hashDouble.getCollisions() << "\n";
    cout << "Factor de carga: " << hashDouble.loadFactor(keys.size()) << "\n";
